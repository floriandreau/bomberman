...
// récupe joueur 3
let troi = document.getElementById("troi");
troi.classList.remove("hide");
let vie_3 = 3;
let div_vie_3 = document.getElementById("vie_troi");
div_vie_3.innerHTML="<br><br><br>vie : "+vie_2;
div_vie_3.classList.remove('hide');
troi.style.left = "600px"
troi.style.top = "50px"

// récupe joueur 4
let quatre = document.getElementById("quatre");
quatre.classList.remove("hide");
let vie_4 = 3;
let div_vie_4 = document.getElementById("vie_quatre");
div_vie_4.innerHTML="<br><br><br>vie : "+vie_2;
div_vie_4.classList.remove('hide');
quatre.style.left = "50px"
quatre.style.top = "600px"
              ...
              if (element_obs.offsetLeft < element.offsetLeft +50 && element_obs.offsetLeft + 50 > element.offsetLeft&&
               ...
               if (element.id == "carre") {
                 if (deux.offsetLeft < element.offsetLeft +50 && deux.offsetLeft + 50 > element.offsetLeft&&
                   ...
                   ||
                   troi.offsetLeft < element.offsetLeft +50 && troi.offsetLeft + 50 > element.offsetLeft&&
                   troi.offsetTop < element.offsetTop +50 && troi.offsetTop + 50 > element.offsetTop
                   ||
                   quatre.offsetLeft < element.offsetLeft +50 && quatre.offsetLeft + 50 > element.offsetLeft&&
                   quatre.offsetTop < element.offsetTop +50 && quatre.offsetTop + 50 > element.offsetTop
                   ) {
                     top_element -= 50;
               ...
               if (element.id == "troi") {
                if (carre.offsetLeft < element.offsetLeft +50 && carre.offsetLeft + 50 > element.offsetLeft&&
                  carre.offsetTop < element.offsetTop +50 && carre.offsetTop + 50 > element.offsetTop 
                  ||
                  deux.offsetLeft < element.offsetLeft +50 && deux.offsetLeft + 50 > element.offsetLeft&&
                  deux.offsetTop < element.offsetTop +50 && deux.offsetTop + 50 > element.offsetTop
                  ||
                  quatre.offsetLeft < element.offsetLeft +50 && quatre.offsetLeft + 50 > element.offsetLeft&&
                  quatre.offsetTop < element.offsetTop +50 && quatre.offsetTop + 50 > element.offsetTop) {
...
function boom(element, index, position_left_bombe, position_top_bombe) {
  ...
  setTimeout(function(){
    ...
    if (element.offsetLeft < troi.offsetLeft +50 && element.offsetLeft + 150 > troi.offsetLeft&&
      element.offsetTop < troi.offsetTop +50 && element.offsetTop + 150 > troi.offsetTop) {
      point_vie_3();
    }
    if (element.offsetLeft < quatre.offsetLeft +50 && element.offsetLeft + 150 > quatre.offsetLeft&&
      element.offsetTop < quatre.offsetTop +50 && element.offsetTop + 150 > quatre.offsetTop) {
      point_vie_4();
    }
...
window.addEventListener("keydown", function(event) {
  ...
  switch (event.keyCode) {
    ...
    case 85:
        //code quand on va en haut
        troi.style.background="url(sprite_jeu_js/sprite_j2/haut.gif)";
        move(troi, "haut");
        setTimeout(function(){
          troi.style.background = "url(sprite_jeu_js/sprite_j2/normal.gif)";
         },500);
        break;
      ...
      case 75:
        //code quand on va à droite
        troi.style.background="url(sprite_jeu_js/sprite_j2/droite.gif)";
      ...
      //bas
      case 74:
          troi.style.background="url(sprite_jeu_js/sprite_j2/bas.gif)";
      ...
      case 72:
        //code quand on va à gauche
        troi.style.background="url(sprite_jeu_js/sprite_j2/gauche.gif)";
      ...
      case 188:
        ...
        if (vie_3 > 0) {
          ...
          let bombe_existe = document.getElementsByClassName("bombe_troi");
          if(bombe_existe.length<3){
            troi.style.background = "url(sprite_jeu_js/sprite_j2/bomb.gif)"
            bombe(troi);
            setTimeout(function(){
              troi.style.background = "url(sprite_jeu_js/sprite_j2/normal.gif)";
             },500);
...
window.addEventListener("keydown", function(event) {
  ...
  switch (event.keyCode) {
    ...
    case 104:
        //code quand on va en haut
        quatre.style.background="url(sprite_jeu_js/sprite_j2/haut.gif)";
        move(quatre, "haut");
        setTimeout(function(){
          quatre.style.background = "url(sprite_jeu_js/sprite_j2/normal.gif)";
         },500);
        break;
      ...
      case 102:
        //code quand on va à droite
        quatre.style.background="url(sprite_jeu_js/sprite_j2/droite.gif)";
      ...
      //bas
      case 101:
          quatre.style.background="url(sprite_jeu_js/sprite_j2/bas.gif)";
      ...
      case 100:
        //code quand on va à gauche
        quatre.style.background="url(sprite_jeu_js/sprite_j2/gauche.gif)";
      ...
      case 99:
        ...
        if (vie_4 > 0) {
          ...
          let bombe_existe = document.getElementsByClassName("bombe_quatre");
          if(bombe_existe.length<3){
            quatre.style.background = "url(sprite_jeu_js/sprite_j2/bomb.gif)"
            bombe(quatre);
            setTimeout(function(){
              quatre.style.background = "url(sprite_jeu_js/sprite_j2/normal.gif)";
             },500);
...
function point_vie(){
 ...
 if(vie_2 == 0  && vie == 0 && vie_3 == 0){
  let popup = document.getElementById ("popup");
  popup.classList.remove("hide") ;
  p.innerHTML="Le joueur 4 à gagné";
  vie_1 = 0;
  div_vie_1.innerHTML="<br><br><br>vie : "+vie_1;
}
if(vie_2 == 0  && vie == 0 && vie_4 == 0){
  let popup = document.getElementById ("popup");
  popup.classList.remove("hide") ;
  p.innerHTML="Le joueur 3 à gagné";
  vie_1 = 0;
  div_vie_1.innerHTML="<br><br><br>vie : "+vie_1;
}
if(vie == 0  && vie_4 == 0 && vie_3 == 0){
  let popup = document.getElementById ("popup");
  popup.classList.remove("hide") ;
...
if(vie_2 == 0  && vie_4 == 0 && vie_3 == 0){
 ...
 function point_vie_3(){
  vie_3 -= 1;
  div_vie_3.innerHTML="<br><br><br>vie : "+vie_3;
  troi.style.background = "url(sprite_jeu_js/sprite_j2/degat.gif)";
  setTimeout(function(){
    troi.style.background = "url(sprite_jeu_js/sprite_j2/normal.gif)";
   },500);
  
  if(vie_3 == 0  || vie_3 < 0){
    troi.style.background="url(sprite_jeu_js/sprite_j2/mort.gif)";
    troi = document.getElementById("troi").id ="troi_mort";
    vie_3 = 0;
    div_vie_3.innerHTML="<br><br><br>vie : "+vie_3;
 }
 if(vie_2 == 0  && vie == 0 && vie_3 == 0){
...
if(vie_2 == 0  && vie_4 == 0 && vie_3 == 0){
 ...
 function point_vie_4(){
  vie_4 -= 1;
  div_vie_4.innerHTML="<br><br><br>vie : "+vie_4;
  quatre.style.background = "url(sprite_jeu_js/sprite_j2/degat.gif)";
  setTimeout(function(){
    quatre.style.background = "url(sprite_jeu_js/sprite_j2/normal.gif)";
   },500);
  
  if(vie_4 == 0  || vie_4 < 0){
    quatre.style.background="url(sprite_jeu_js/sprite_j2/mort.gif)";
    quatre = document.getElementById("quatre").id ="quatre_mort";
    vie_4 = 0;
    div_vie_4.innerHTML="<br><br><br>vie : "+vie_4;
 }
 if(vie == 0  && vie_4 == 0 && vie_3 == 0){
